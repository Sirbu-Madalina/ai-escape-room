...
export const createFallbackCorruptedDocumentsPuzzle = () => {
  return {
    title: "Beacon Drift",
    riddle: "Three damaged files survived the signal storm. Recover their fragments and assemble the command hidden in the trail.",
    hint: "The trace line describes what happened to each fragment. Compare the damage patterns before typing the command.",
    explanation: "The damaged fragments recover as OVERRIDE, NEON, and BEACON. Together they form the command OVERRIDE NEON BEACON.",
    kind: "corrupted-documents",
    documents: [
      {
        id: "doc-1",
        title: "Signal_Override.tmp",
        classification: "DAMAGED / 42%",
        puzzleType: "missing-letters",
        corruptedText: "OBJECTIVE: Recover fragment A from the damaged record.\nCORRUPTED LINE: Emergency console accepted token _VERRIDE before the room lights blinked twice.\nTRACE: One character was erased from a critical token.",
        clue: "The damaged token still has its outline. Restore the missing character.",
        hiddenClue: "OVERRIDE",
        clueLabel: "Fragment A",
        orderHint: "Earliest timestamp in the incident chain.",
      },
      {
        id: "doc-2",
        title: "Color_Channel.redacted",
        classification: "DAMAGED / 35%",
        puzzleType: "reverse-word",
        corruptedText: "OBJECTIVE: Recover fragment B from the damaged record.\nCORRUPTED LINE: The lighting log kept repeating noen whenever the hallway tried to reboot.\nTRACE: A token was written backwards during the archive crash.",
        clue: "The suspicious fragment reads correctly only from the other direction.",
        hiddenClue: "NEON",
        clueLabel: "Fragment B",
        orderHint: "Routing fragment from the middle log.",
      },
      {
        id: "doc-3",
        title: "Broadcast_Target.glitch",
        classification: "DAMAGED / 28%",
        puzzleType: "remove-symbols",
        corruptedText: "OBJECTIVE: Recover fragment C from the damaged record.\nCORRUPTED LINE: The final transmitter label became B@@E##A!!C%%O^^N after the archive surge.\nTRACE: Noise symbols were injected between the real letters.",
        clue: "Ignore the symbols and keep the letters in the order they appear.",
        hiddenClue: "BEACON",
        clueLabel: "Fragment C",
        orderHint: "Final authorization fragment.",
      },
    ],
    answer: "override neon beacon",
