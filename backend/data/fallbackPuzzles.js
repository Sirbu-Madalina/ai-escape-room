...
export const createFallbackCorruptedDocumentsPuzzle = () => {
  return {
    ...
    explanation: "The missing-letters file repairs OP_N into OPEN. The hidden-word file contains THE as the only full uppercase word. The symbol-cleaning file repairs V@@A##U!!L%%T into VAULT. The restored command is OPEN THE VAULT.",
    ...
    documents: [
      {
        ...
        corruptedText: "TASK: Recover word 1.\nCORRUPTED LINE: Door control says OP_N the sealed vault before the alarm resets.\nNOTE: One missing vowel completes the action word.",
        clue: "Fill the missing vowel to make the action used on a door.",
        hiddenClue: "OPEN",
        clueLabel: "Word 1",
