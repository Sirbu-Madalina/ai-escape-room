...
const fallbackEmailInvestigationPuzzles = [
  ...
  },
  {
    ...
    hint: "Find the department prefix, the incident number, and the approval initial.",
    explanation: "The compliance memo gives the archive prefix AR. The incident report identifies ticket 418. The approval note says Mira Vale approved the reset, so the final initial is V. The final override code is AR418V.",
    kind: "email-investigation",
    employeeProfile: {
      name: "Mira Vale",
    ...
    clues: [
      { label: "Archive prefix", value: "Archive reset = AR", discovered: true },
      { label: "Incident number", value: "Ticket 418", discovered: true },
      { label: "Approval initial", value: "Vale = V", discovered: false },
      { label: "Code format", value: "prefix + ticket + initial", discovered: false },
    ],
    emails: [
      {
        id: "email-1",
        ...
        body: "For emergency archive resets, the approved department prefix is AR. Do not use ARC; that belongs to cold storage.",
        time: "8:31 AM",
        priority: "clue",
        clueSummary: "Archive reset prefix is AR.",
      ...
      },
      {
        ...
        body: "The corrupted archive blackout is now assigned to ticket 418. Please keep all reset requests tied to that incident number.",
        time: "9:02 AM",
        priority: "clue",
        clueSummary: "Incident number is 418.",
      ...
      },
      {
        ...
        body: "I approved the archive reset. Since two leads are online today, append my surname initial, V, to the reset code.",
        time: "9:49 AM",
        priority: "clue",
        clueSummary: "Approval initial is V.",
        attachmentName: "",
      ...
      },
      {
        ...
        body: "Keep the prefix, incident number, and approval marker in different threads. A single search should not expose the whole reset code.",
        time: "May 12",
        priority: "danger",
    ...
    answer: "ar418v",
    inputPlaceholder: "Enter archive code, e.g. AR418V",
  },
  {
    title: "Server Room Handoff",
    riddle: "Search the handoff emails and recover the temporary server access code.",
    hint: "The final code combines a server fragment, a floor number, and a backup window.",
    explanation: "The infrastructure email gives server fragment NX. The facilities note places the rack on floor 5. The backup message says the approved window is Dawn, marked D. The final access code is NX5D.",
    kind: "email-investigation",
    employeeProfile: {
      name: "Jon Ivers",
    ...
    clues: [
      { label: "Server fragment", value: "Nexora node = NX", discovered: true },
      { label: "Floor", value: "Floor 5", discovered: true },
      { label: "Backup window", value: "Dawn = D", discovered: false },
      { label: "Code format", value: "server + floor + window", discovered: false },
    ],
    emails: [
      {
        id: "email-1",
        ...
        body: "For the handoff, remember that Nexora compute nodes use the server fragment NX in all temporary access codes.",
        time: "7:58 AM",
        priority: "clue",
        clueSummary: "Server fragment is NX.",
      ...
      },
      {
        ...
        body: "The Nexora rack has been moved from floor 3 to floor 5. Old floor notes are no longer valid.",
        time: "8:27 AM",
        priority: "clue",
        clueSummary: "Nexora rack is on floor 5.",
      ...
      },
      {
        ...
        body: "Tonight's server handoff uses the Dawn backup window. In temporary codes, Dawn is marked with D.",
        time: "9:06 AM",
        priority: "clue",
        clueSummary: "Backup window marker is D.",
    ...
    answer: "nx5d",
    inputPlaceholder: "Enter server code, e.g. NX5D",
  },
  {
    title: "Prototype Transfer",
    riddle: "Search the inbox to reconstruct the temporary transfer approval code.",
    hint: "Collect the prototype prefix, the crate number, and the courier marker.",
    explanation: "The lab note says Aurora prototype uses AU. The logistics update assigns crate 62. The courier memo says Raven is marked R. The final transfer code is AU62R.",
    kind: "email-investigation",
    employeeProfile: {
      name: "Dr. Salma Rook",
    ...
    clues: [
      { label: "Prototype prefix", value: "Aurora = AU", discovered: true },
      { label: "Crate number", value: "Crate 62", discovered: true },
      { label: "Courier marker", value: "Raven = R", discovered: false },
      { label: "Code format", value: "prefix + crate + courier", discovered: false },
    ],
    emails: [
      {
        id: "email-1",
        ...
        body: "For temporary transfer approvals, Aurora should be shortened to AU. Do not use AUR; that is archived.",
        time: "11:04 AM",
        priority: "clue",
        clueSummary: "Prototype prefix is AU.",
      ...
      },
      {
        ...
        body: "Aurora transfer materials are now packed in crate 62. Ignore the staging note that says crate 26.",
        time: "11:38 AM",
        priority: "clue",
        clueSummary: "Crate number is 62.",
      ...
      },
      {
        ...
        body: "The approved courier route is Raven. For the temporary transfer code, Raven is marked with R.",
        time: "12:02 PM",
        priority: "clue",
        clueSummary: "Courier marker is R.",
    ...
    answer: "au62r",
    inputPlaceholder: "Enter transfer code, e.g. AU62R",
  },
];
...
export const createFallbackCorruptedDocumentsPuzzle = () => {
  return {
    title: "Corrupted Documents",
    riddle: "Three damaged files each contain one readable recovery word. Open the files in order, collect the words, and enter the phrase.",
    hint: "Look for the line that starts with 'Recovered word'. Each file gives one full word, and the answer uses the file order shown on the left.",
    explanation: "Document 1 gives TRACE, document 2 gives THE, and document 3 gives SOURCE. In document order, the recovery phrase is TRACE THE SOURCE.",
    kind: "corrupted-documents",
    documents: [
      {
        id: "doc-1",
        title: "Incident_Report.tmp",
        classification: "DAMAGED / 42%",
        corruptedText: "System notice: transfer log failed during archive repair.\n\nMost lines are checksum noise, but the readable recovery marker survived:\n\nRecovered word: [TRACE]\n\nUse this as the first word in the restored phrase.",
        hiddenClue: "TRACE",
        clueLabel: "Word 1",
      },
      {
        ...
        corruptedText: "Memo recovered with missing vowels:\n\nThe archive door will only open when the missing phrase is restored.\n\nRecovered word: [THE]\n\nPlace this after the first recovered word.",
        hiddenClue: "THE",
        clueLabel: "Word 2",
      },
      {
        id: "doc-3",
        title: "Archive_Index.glitch",
        classification: "DAMAGED / 28%",
        corruptedText: "Archive index is unstable. Several fake entries repeat with broken symbols.\n\nS0URC3 is invalid. SO//UR//CE is damaged.\n\nRecovered word: [SOURCE]\n\nUse this as the final word.",
        hiddenClue: "SOURCE",
        clueLabel: "Word 3",
      },
    ],
    answer: "trace the source",
